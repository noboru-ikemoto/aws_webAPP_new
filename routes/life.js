 ...
 *File Name : life.js
 *Version : $Id: life.js 322 2020-04-14 01:40:07Z tms002 $
...
module.exports = () => {
    ...
    route.get('/data', async (req, res) => { // url : /life/data
    ...
    route.get('/threshold', async (req, res) => { // url : /life/threshold
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.post('/threshold', async (req, res) => { // url : /life/threshold
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/lifetagplus', async (req, res) => { // url : /life/tagplus
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/lifetagplus/tagicons', async (req, res) => { // url : /life/lifetagplus/tagicons
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/absence', async (req, res) => { // url : /life/absence get
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.post('/absence', async (req, res) => { // url : /life/absence post
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/', async (req, res) => { // url : /life/
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
