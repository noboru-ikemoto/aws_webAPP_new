 ...
 *File Name : lifeReaction.js
 *Version : $Id: lifeReaction.js 322 2020-04-14 01:40:07Z tms002 $
...
module.exports = () => {
    ...
    route.get('/data', async (req, res) => { // url : /lifeReaction/data
    ...
    route.get('/threshold', async (req, res) => { // url : /lifeReaction/threshold
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.post('/threshold', async (req, res) => { // url : /lifeReaction/threshold
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/lifetagplus', async (req, res) => { // url : /lifeReaction/tagplus
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/lifetagplus/tagicons', async (req, res) => { // url : /lifeReaction/lifetagplus/tagicons
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/absence', async (req, res) => { // url : /lifeReaction/absence get
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.post('/absence', async (req, res) => { // url : /lifeReaction/absence post
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
    ...
    route.get('/', async (req, res) => { // url : /lifeReaction/
        if (!req.user || !req.user.id_user) {
            // not login
            req.logOut();
            res.redirect('/');
